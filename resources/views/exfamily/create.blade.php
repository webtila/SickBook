...
@section('content')
    <div>
        <div>
            <a href="/inservice">
                <h1 class="text-center pb-1">New Exfamily Records</h1>
            </a>
        </div>
    </div>
    @if($errors->any())
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="ex_staff_name" class="form-control" placeholder="Jumla">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="pension" class="form-control" placeholder="Jumla">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="date" name="book_expiry" class="form-control" placeholder="XXXXX">
                                    </div>
                                </div>
