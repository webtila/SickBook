...
@section('content')
    <div class="  container-fluid  text-center mx-auto pt-1 col-sm-5">
        ...
        <hr>  
 <a href="/inservice" 
    class="btn btn-primary btn-block btn-vlg "data-toggle="tooltip" 
    data-placement="top" title="बहालवाला प्रहरी कर्मचारी">Inservice <span class="ml-5 btn text-primary bg-white">{{$ins_count}}</span>  </a>
 
<a href="/infamily" 
    class="btn btn-secondary btn-block btn-vlg"data-toggle="tooltip"
...
<br><hr>
<a href="/exservice" 
    class="btn btn-danger btn-block btn-vlg"data-toggle="tooltip" 
    data-placement="top" title="भुतपर्व प्रहरी कर्मचारी">ExService <span class="ml-5 btn text-danger bg-white"> {{$exs_count}}</span></a>
<a href="/exfamily"
    class="btn btn-warning btn-block btn-vlg"data-toggle="tooltip"
